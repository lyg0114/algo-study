...
public class MergeTwoSortedLists {
  ...
  private static MergeTwoSortedListsInterface getSolution() {
    return new MergeTwoSortedListsSolution();
  }
}
...
class MergeTwoSortedListsSolution2 implements MergeTwoSortedListsInterface {
...
class MergeTwoSortedListsSolution3 implements MergeTwoSortedListsInterface {
