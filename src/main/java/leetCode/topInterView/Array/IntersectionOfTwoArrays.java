...
public class IntersectionOfTwoArrays {
  ...
  public static void main(String[] args) {
    int[] nums1 = {1, 2, 2, 1};
    int[] nums2 = {2, 2};
    IntersectionOfTwoArraysInterface solutoin = getSolutoin();
  ...
  public static IntersectionOfTwoArraysInterface getSolutoin() {
    return new IntersectionOfTwoArraysSolutoinV1();
  }

  public static class IntersectionOfTwoArraysSolutoinV1 implements
      IntersectionOfTwoArraysInterface {
  ...
  public interface IntersectionOfTwoArraysInterface {
