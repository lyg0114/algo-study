...
public class LongestCommonPrefix {
  ...
  public static void main(String[] args) {
    LongestCommonPrefixInterface solution = getSolution();
    String[] strs = {"abc", "def"};
    String s = solution.longestCommonPrefix(strs);
    System.out.println("s = " + s);
  }

  public static LongestCommonPrefixInterface getSolution() {
    return new LongestCommonPrefixSolutionV1();
  }

  public static class LongestCommonPrefixSolutionV1 implements LongestCommonPrefixInterface {
  ...
  public interface LongestCommonPrefixInterface {
